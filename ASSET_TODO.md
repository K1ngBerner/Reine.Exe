...
- **Atividades atuais**: preenchidas em `src/data/current.ts`, com PT/EN.
...
- **Marcas esportivas**: as oito logos estão instaladas e validadas em produção local. Ferrari usa a marca distribuída pela Formula 1. As siglas permanecem apenas como segurança.
...
Nenhum asset obrigatório desta revisão está pendente. Collection usa objetos gráficos em CSS, sem depender de downloads. Publicação no Netlify não foi executada nesta tarefa.
